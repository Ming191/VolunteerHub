...
class EventMapper(private val eventCapacityService: EventCapacityService) {
    ...
    fun toEventResponse(event: Event): EventResponse {
        ...
        return EventResponse(
                ...
                availableSpots =
                        eventCapacityService.getAvailableSpots(event.id, event.maxParticipants),
    ...
    /**
     * Map list of Event entities to list of EventResponse DTOs OPTIMIZED: Uses batch query to avoid
     * N+1 problem
     */
