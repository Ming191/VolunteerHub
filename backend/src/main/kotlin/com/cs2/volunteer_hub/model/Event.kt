...
data class Event(
    ...
    @Column(length = 500) var location: String,
    ...
    /** Maximum number of participants allowed for this event null = unlimited capacity */
    var maxParticipants: Int? = null,

    /**
     * Whether waitlist is enabled when event reaches capacity If false, registrations are
     * rejected when full
     */
    ...
    @Column(length = 500) var rejectionReason: String? = null,

    /** Timestamp when event was cancelled */
    var cancelledAt: LocalDateTime? = null,

    /** Reason for event cancellation */
    @Column(length = 500) var cancelReason: String? = null,
    ...
    /**
     * Check if event can accept registrations Considers event status, registration deadline, and
