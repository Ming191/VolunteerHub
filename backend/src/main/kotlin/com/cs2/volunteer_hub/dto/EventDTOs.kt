...
data class EventResponse(
        ...
        // val galleryImageUrls: List<GalleryImageResponse>, // Removed for performance
...
@Schema(description = "Paginated response for gallery images")
data class PageGalleryImageResponse(
        val content: List<GalleryImageResponse>,
        val pageNumber: Int,
        val pageSize: Int,
    ...
    companion object {
        fun from(page: Page<GalleryImageResponse>): PageGalleryImageResponse {
            return PageGalleryImageResponse(
