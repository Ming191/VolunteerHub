...
export default function AdminDashboard() {
  ...
  const [eventsToApprove, setEventsToApprove] = useState<DashboardActionItem[]>([]);
  const [metricsData, setMetricsData] = useState<SystemMetricsResponse | null>(null);
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setUserRoleCounts(response.data.userRoleCounts || {});
        setEventsToApprove(response.data.eventsToApprove || []);
      } catch (error) {
