        ...
        <div className="container mx-auto p-6">
            ...
            {events.length === 0 ? (
                <Card className="p-12 text-center">
                    <p className="text-muted-foreground text-lg">No pending events to review</p>
                </Card>
            ) : (
                        ...
                        <AlertDialogDescription>
                            {action === 'approve' ? (
                                <>
                                    ...
                                    <strong>{selectedEvent?.title}</strong>"? This will make it visible to
                                    all volunteers.
                                </>
                            ) : (
                                <>
