        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              className="w-full border-2 focus-visible:ring-0"
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              <Button
                ...
                variant="outline"
                className="flex-1 border-2 border-green-600 bg-green-600 text-white hover:bg-green-700 hover:border-green-700"
              >
                Apply
              </Button>
              <Button
                ...
                variant="outline"
                className="flex-1 border-2 hover:bg-gray-100 hover:border-gray-400 transition-colors"
              >
                Clear
              </Button>
            </div>
          ...
          <div className="flex items-center space-x-2">
            <Checkbox
              ...
              onCheckedChange={(checked) =>
                setFilters({ ...filters, upcoming: !!checked })
              }
            />
            <Label
              htmlFor="upcoming"
